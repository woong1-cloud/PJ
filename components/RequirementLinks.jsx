      ...
      form={({ close }) => (
        ...
        >
          <input
            ...
            className="h-7 rounded border border-slate-300 px-2 text-xs placeholder:text-slate-400 focus:border-indigo-400 focus:outline-none"
          />
    ...
    >
      ...
      {links.length === 0 ? (
        ...
        <ul className="flex flex-col gap-1">
          {links.map((l) => (
            <li key={l.id} className="group flex items-center justify-between gap-2 text-xs">
